...
<input class="input" type="hidden" name="id_empresa" value="<?= $edit ['id_empresa']; ?>" />
 

<div class="row p0 m0">
    <div class="col-12 p0 m0 pL5 p0_oS order-1 order-lg-3 mb20_oS">
        <div class="pAA10">
            <div class="label">¿Estás seguro de eliminar este registro? Esta acción es irreversible y eliminará permanentemente la información del colaborador.</div>
