<?php
    $edit = 0;
    if($edit = $_ZOOM->get_data( "grw_grupos", " AND uuid = '".$_MOD['gist']."' AND eliminado = 0 ", 0)){
...
<div class="row p0 m0">
    <div class="col-12 col-lg-12 p0 m0 pR5 p0_oS">
        <div class="pAA10">
            ...
            <input class="input" type="text" name="nom_grupo" <?php if($edit['nom_grupo'] != '') echo 'value="'.$edit['nom_grupo'].'"'; ?> />
        </div>
    </div>
</div>
...
<div class="row p0 m0">
    <div class="col-12 col-lg-12 p0 m0 pR5 p0_oS">
        <div class="pAA10">
            ...
            <input class="input" type="text" name="descrp_grupo" <?php if($edit['descrp_grupo'] != '') echo 'value="'.$edit['descrp_grupo'].'"'; ?> />
        </div>
    </div>
</div>
