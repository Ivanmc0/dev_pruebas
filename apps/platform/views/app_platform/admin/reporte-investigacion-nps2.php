                                    ...
                                    if($pre["id_modo"] == 1){
                                        ...
                                        if($respuestas){
                                            foreach($respuestas["respuestas"] AS $key => $resp){
                                                ...
                                                $color = $resp["icono"] == 'las la-angry' ? '#fb2233' : ( $resp["icono"] == 'las la-frown' ? '#f5760f' : ( $resp["icono"] == 'las la-meh' ? '#f1ae22' : ( $resp["icono"] == 'las la-smile' ? '#0abe50' : '#089954' ) ) );
                                                echo '<div class="tabIn w40x"><div class="t24 wh30 rr50 colorfff mAUTO" style="background-color:'.$color.';"><div class="vMM"><i class="'.($resp["icono"]).'"></i></div></div></div>';
                                                echo '<div class="tabIn"><div class="ff3 t16" style="color:'.$color.';">'.($resp["nombre"]).'</div></div>';
