    ...
    if($registro = $_ZOOM->get_data("grw_val_listas", " AND uuid = '".$uid[0]."' AND id_empresa = ".$_SESSION['COMPANY']['id']." AND eliminado = 0 ", 0)){
        ...
        echo '
            <div class="tab bBS1 bCeee pAA20 mb50">
                ...
                <div class="tabIn taR">
        ';
                if(isset($botoneshabilitados['79ec5e78-389b-11ef-94c7-b42e99a5cf9a'])){
                    $boton = $botoneshabilitados['79ec5e78-389b-11ef-94c7-b42e99a5cf9a'];
                    $size = 'zs';
                    $perz = '';
...
<div class="generalMin">
    ...
    <div class="bfff bShadow3 rr20 p30 p20_oS mb50 mb30_oS" style="overflow: hidden;">
        ...
        <div class="tab mb30">
            ...
            <div class="tabIn taR">
                <?php
                    if(isset($botoneshabilitados['79e5b66a-389b-11ef-94c7-b42e99a5cf9a'])){
                        $boton = $botoneshabilitados['79e5b66a-389b-11ef-94c7-b42e99a5cf9a'];
                        $size = 'zs';
                        $perz = '';
                        include '../views/components/boton_float.php';
                    }
...
<?php
    if($mud = $_PLATFORM->PermissionValidationModel ($app, 'lista-externa-miembros', true)){
?>
