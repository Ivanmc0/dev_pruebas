<?php
    if($registro = $_ZOOM->get_data("grw_organigramas", " AND uuid = '".$uid[0]."' AND id_empresa = ".$_SESSION['COMPANY']['id']." AND eliminado = 0 ", 0)){
        ...
        echo '
            <div class="tab bBS1 bCeee pAA20 mb50">
                ...
                <div class="tabIn taR">
        ';
                if(isset($botoneshabilitados['39d878d2-1164-11ef-98cf-b42e99a5cf9a'])){
                    $boton = $botoneshabilitados['39d878d2-1164-11ef-98cf-b42e99a5cf9a'];
                    $size = 'zs';
                    $perz = '';
...
<div class="generalMin">
    ...
    <div class="bfff bShadow3 rr20 p30 p20_oS mb50 mb30_oS" style="overflow: hidden;">
        ...
        <div class="tab mb30">
            ...
            <div class="tabIn taR">
                <?php
                    if(isset($botoneshabilitados['39de8480-1164-11ef-98cf-b42e99a5cf9a'])){
                        $boton = $botoneshabilitados['39de8480-1164-11ef-98cf-b42e99a5cf9a'];
                        $size = 'zs';
                        $perz = '';
                        include '../views/components/boton_float.php';
                    }
        ...
        <div class="row bBS1 bCeee p2010">
            <div class="col-12 col-lg-4">
                <div class="t16 ff0 color666">Principal</div>
            </div>
            <div class="col-12 col-lg-8">
                <?php if($registro['activo'] == 1){ ?><div class="dIB t18"><i class="las la-check-circle colorVerde"></i><span class="pL5 ff2">Si</span></div><?php } ?>
                <?php if($registro['activo'] == 0){ ?><div class="dIB t18"><i class="las la-minus-circle colorRojo"></i><span class="pL5 ff2">No</span></div><?php } ?>
            </div>
        </div>
...
<?php
    if($mud = $_PLATFORM->PermissionValidationModel ($app, 'org-cargos', true)){
?>
