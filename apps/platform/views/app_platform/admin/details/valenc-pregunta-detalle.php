<?php
    if($registro = $_ZOOM->get_data("grw_val_preguntas", " AND uuid = '".$uid[0]."' AND eliminado = 0 ", 0)){

        $modo = $registro['id_modo'];
        ...
        echo '
            <div class="tab bBS1 bCeee pAA20 mb50">
                ...
                <div class="tabIn taR">
        ';
                if(isset($botoneshabilitados['395bc7ec-2416-11ef-9382-b42e99a5cf9a'])){
                    $boton = $botoneshabilitados['395bc7ec-2416-11ef-9382-b42e99a5cf9a'];
                    $size = 'zs';
                    $perz = '';
...
<div class="generalMin">
    ...
    <div class="bfff bShadow3 rr20 p30 p20_oS mb50 mb30_oS" style="overflow: hidden;">
        ...
        <div class="tab mb30">
            ...
            <div class="tabIn taR">
                <?php
                    if(isset($botoneshabilitados['3957a581-2416-11ef-9382-b42e99a5cf9a'])){
                        $boton = $botoneshabilitados['3957a581-2416-11ef-9382-b42e99a5cf9a'];
                        $size = 'zs';
                        $perz = '';
                        include '../views/components/boton_float.php';
                    }
        ...
        <div class="row bBS1 bCeee p2010">
            ...
            <div class="col-12 col-lg-7">
                <div class="t18 ff2 color333"><?= $registro['id_modo']; ?></div>
            </div>
            <div class="col-12 col-lg-1 taR"><i class="las la-check t20 colorVerde"></i></div>
        </div>
...
<?php
    if($modo != 5){
        if($mud = $_PLATFORM->PermissionValidationModel ($app, 'valenc-respuestas', true)){
?>
