<?php
    if($registro = $_ZOOM->get_data("grw_segmentaciones", " AND uuid = '".$uid[0]."' AND id_empresa = ".$_SESSION['COMPANY']['id']." AND eliminado = 0 ", 0)){
        ...
        echo '
            <div class="tab bBS1 bCeee pAA20 mb50">
                ...
                <div class="tabIn taR">
        ';
                if(isset($botoneshabilitados['39d878d2-1164-11ef-98cf-b42e99a45123'])){
                    $boton = $botoneshabilitados['39d878d2-1164-11ef-98cf-b42e99a45123'];
                    $size = 'zs';
                    $perz = '';
...
<div class="generalMin">
    ...
    <div class="bfff bShadow3 rr20 p30 p20_oS mb50 mb30_oS" style="overflow: hidden;">
        ...
        <div class="tab mb30">
            ...
            <div class="tabIn taR">
                <?php
                    if(isset($botoneshabilitados['39de8480-1164-11ef-98cf-b42e99a51234'])){
                        $boton = $botoneshabilitados['39de8480-1164-11ef-98cf-b42e99a51234'];
                        $size = 'zs';
                        $perz = '';
                        include '../views/components/boton_float.php';
                    }
...
<?php
    if($mud = $_PLATFORM->PermissionValidationModel ($app, 'segmento-opciones', true)){
?>
