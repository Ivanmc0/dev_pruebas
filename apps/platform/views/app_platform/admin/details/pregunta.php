<?php
    $AddToQuery = "AND  PREGS.uuid='$uid[0]'" ;


    if($registro = $_GROWI->GET('LELE', 'GetPreguntas', $AddToQuery  , ['empresa' => 'PREGS.id_empresa'], $ReturnRecord = true) ){

        $modo = $registro['preg_tipo_id'];
        ...
        $misBotones         = '';
        $registro['uuid']   = $registro['preg_uuid'];
        $registro['id']     = $registro['preg_id'];
        ...
        echo '
            <div class="tab bBS1 bCeee pAA20 mb50">
                ...
                <div class="tabIn pLR20 pLR10_oS">
                    ...
                    <div class="t18 ff2 color666">'.$mud['descripcion'].' '.$registro['preg_nombre'].'</div>
                </div>
                <div class="tabIn taR">
        ';
                if(isset($botoneshabilitados['93dc4e65-1303-11ef-93d8-b42e99a5cf9a'])){
                    $boton = $botoneshabilitados['93dc4e65-1303-11ef-93d8-b42e99a5cf9a'];
                    $size = 'zs';
                    $perz = '';
...
<div class="generalMin">
    ...
    <div class="bfff bShadow3 rr20 p30 p20_oS mb50 mb30_oS" style="overflow: hidden;">
        ...
        <div class="tab mb30">
            ...
            <div class="tabIn taR">
                <?php
                    if(isset($botoneshabilitados['93c945d0-1303-11ef-93d8-b42e99a5cf9a'])){
                        $boton = $botoneshabilitados['93c945d0-1303-11ef-93d8-b42e99a5cf9a'];
                        $size = 'zs';
                        $perz = '';
                        include '../views/components/boton_float.php';
                    }
        ...
        <div class="row bBS1 bCeee p2010">
            ...
            <div class="col-12 col-lg-8 taR">
                <?php if($registro['preg_inactivo'] == 0){ ?><div class="dIB bVerde colorfff p510 rr5 t14"><i class="las la-check-circle"></i><span class="pL5 ff1">Activo</span></div><?php } ?>
                <?php if($registro['preg_inactivo'] == 1){ ?><div class="dIB bRojo colorfff p510 rr5 t14"><i class="las la-minus-circle"></i><span class="pL5 ff1">Inactivo</span></div><?php } ?>
            </div>
        </div>

        <div class="row bBS1 bCeee p2010">
            <div class="col-12 col-lg-4">
                <div class="t16 ff0 color666">Pregunta.</div>
            </div>
            <div class="col-12 col-lg-7">
                <div class="t18 ff2 color333"><?= $registro['preg_nombre']; ?></div>
            </div>
            <div class="col-12 col-lg-1 taR"><i class="las la-check t20 colorVerde"></i></div>
        </div>

        <div class="row bBS1 bCeee p2010">
            <div class="col-12 col-lg-4"><div class="t16 ff0 color666">Modalidad de pregunta.</div>
            </div>
            <div class="col-12 col-lg-7">
                <div class="t18 ff2 color333"><?= $registro['preg_tipo_nombre']; ?></div>
            </div>
            <div class="col-12 col-lg-1 taR"><i class="las la-check t20 colorVerde"></i></div>
        </div>
        ...
        <div class="row bBS1 bCeee p2010">
            ...
            <div class="col-12 col-lg-7">
                <div class="t18 ff2 color333"><?= $registro['preg_prioridad']; ?></div>
            </div>
            <div class="col-12 col-lg-1 taR"><i class="las la-check t20 colorVerde"></i></div>
        </div>
...
<?php
    if($modo != 5){
        if($mud = $_PLATFORM->PermissionValidationModel ($app, 'inter-respuestas', true)){
?>
