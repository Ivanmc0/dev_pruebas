...
<?php $thiss 		= $_ZOOM->get_data("grw_okr_objetivos", " AND id = ".$geton[2]." AND inactivo = 0 AND eliminado = 0 ", 0); ?>
<?php if($thiss){ ?>

<div class="max700 pAA40 mAUTO">

	<div class="p20 t20 ff3 ff0 colorfff bMorado">
		<small class="ff1 coloreee">Editando el objetivo</small><br><?= ($thiss["nombre"]); ?>
	</div>
	<div class="p30">
