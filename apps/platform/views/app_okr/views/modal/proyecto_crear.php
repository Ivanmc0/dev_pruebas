...
<div class="modal fade" id="proyecto_crear" tabindex="-1" role="dialog" aria-labelledby="proyecto_crearLabel" aria-hidden="true">
		...
		<div class="modal-content">
				...
				<div class="p30">
					<form action="kr/all" id="formion" name="formion" method="post" class="form-horizontal zoom_form">
						...
						<button type="submit" class="btn btn-outline-primary btn-block"><i class="ft-unlock"></i> Crear Proyecto</button>
					</form>
				</div>
