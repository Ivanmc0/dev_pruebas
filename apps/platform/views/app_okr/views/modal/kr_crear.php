...
<div class="modal fade" id="kr_crear" tabindex="-1" role="dialog" aria-labelledby="kr_crearLabel" aria-hidden="true">
		...
		<div class="modal-content">
				...
				<div class="p30">
					<form action="kr/all" id="formion" name="formion" method="post" class="form-horizontal zoom_form">
						...
						<input type="hidden" class="p1020 w100 bS1 rr5 dB mb10" name="id_objetivo" id="id_objetivo" value="<?= $geton[2]; ?>">
						<input type="hidden" class="p1020 w100 bS1 rr5 dB mb10" name="tabla" id="tabla" value="grw_okr_krs">
						...
						<button type="submit" class="btn btn-outline-primary btn-block"><i class="ft-unlock"></i> Crear KR</button>
					</form>
				</div>
