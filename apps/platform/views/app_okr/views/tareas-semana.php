...
<div class="row bS1 bCeee m0 mb50">
    <div class="col-12 col-sm-4 bGray p10">
        <?php $get_homeworks  = $_TUCOACH->get_data("grw_okr_tareas", " AND estado = 0 AND id_semana = ".$week["id"]." AND id_empresa = ".$_SESSION["COMPANY"]["id"]." AND id_proyecto = ".$proyecto["id"]." AND inactivo = 0 AND eliminado = 0 ", 1); ?>
    ...
    <div class="col-12 col-sm-4 beee p10">
        <?php $get_homeworks  = $_TUCOACH->get_data("grw_okr_tareas", " AND estado = 1 AND id_semana = ".$week["id"]." AND id_empresa = ".$_SESSION["COMPANY"]["id"]." AND id_proyecto = ".$proyecto["id"]." AND inactivo = 0 AND eliminado = 0 ", 1); ?>
    ...
    <div class="col-12 col-sm-4 bGray p10">
        <?php $get_homeworks  = $_TUCOACH->get_data("grw_okr_tareas", " AND estado = 2 AND id_semana = ".$week["id"]." AND id_empresa = ".$_SESSION["COMPANY"]["id"]." AND id_proyecto = ".$proyecto["id"]." AND inactivo = 0 AND eliminado = 0 ", 1); ?>
