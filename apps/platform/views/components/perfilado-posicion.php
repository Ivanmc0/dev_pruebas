<div class="dB bfff bShadow3 rr20" style="overflow:hidden">
    ...
    <div class="tab bBS1 p30">
        <div class="tabIn pR20">
            <div class="ff3 t24 color000 mb10">Posición Organizacional</div>
            <div class="ff0 t16 color666">
                Indica quien es tu jefe y cargo para mejorar tu experiencia en la plataforma.
            </div>
        </div>
        <div class="tabIn w80x">
            <div class="wh80 bAzul4 rr50 t50"><div class="vMM rr50"><i class="las la-id-card"></i></div></div>
        </div>
    </div>
