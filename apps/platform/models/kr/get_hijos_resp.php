<?php require_once ('../../appInit.php');
	...
	if($_POST["id"] != "" && $_POST["nivel"] != "" && $_POST["proyecto"] != "" && $_POST["week"] != "" && $_POST["today"] != "" && $_POST["quien"] != ""){
		...
		$datos = $_TUCOACH->get_data($tabla[$nivel]["tabla"], " AND id_proyecto = ".$_SESSION["thisProject"]." AND id_responsable = $quien AND inactivo = 0 AND eliminado = 0 ".$ccodi, 1);
		$ccc = 1;
		if($datos){
			...
			foreach($datos AS $dato){
				...
				if($nivel == 5){
					if($star = $_OKR->get_task(" AND TASK.id = ".$dato["id"]." AND PROY.id = ".$dato["id_proyecto"]." AND EMP.id = ".$_SESSION["COMPANY"]["id"]."  ")){
						...
						echo '
							<div class="">
								<div class="tab">
									<a class="tab20 p510 bN1 color999 bHover" href="'.$_SESSION["_DOMINION"].'proyecto/balance/" data-toggle="tooltip" data-placement="top" title="'.($star["nombre_proyecto"]).'">
									...
									<a class="tab20 p510 bN2 color999 bHover" href="'.$_SESSION["_DOMINION"].'proyecto/objetivo/'.$star["id_objetivo"].'/" data-toggle="tooltip" data-placement="top" title="'.($star["nombre_objetivo"]).'">
									...
									<a class="tab20 p510 bN3 color999 bHover" href="'.$_SESSION["_DOMINION"].'proyecto/kr/'.$star["id_kr"].'/" data-toggle="tooltip" data-placement="top" title="'.($star["nombre_kr"]).'">
									...
									<a class="tab20 p510 bN4 color999 bHover" href="'.$_SESSION["_DOMINION"].'proyecto/accin/'.$star["id_accion"].'/" data-toggle="tooltip" data-placement="top" title="'.($star["nombre_accion"]).'">
									...
									<a class="tab20 p510 bN5 color999 bHover" href="'.$_SESSION["_DOMINION"].'proyecto/sprint/'.$star["id_sprint"].'/" data-toggle="tooltip" data-placement="top" title="'.($star["nombre_sprint"]).'">
				...
				echo '
						<div class="tab">
							<a href="'.$dominion.'proyecto/'. $_TUCOACH->url_seo((strtolower($tabla[$nivel]["nombre"]))).'/'.($dato["id"]).'/" class="tabIn bHover2">
								<div class="tab">
									<div class="tabIn p20">
				';
