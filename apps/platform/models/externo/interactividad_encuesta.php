...
if($interactividad = $_ZOOM->get_data('grw_lel_dinamicas', ' AND id = ' . $_POST["enc"] . ' AND inactivo = 0 AND eliminado = 0', 0)){
    ...
    if($estado = $_ZOOM->interactividad_estado($interactividad['id'], $_POST["t"])){
                    ...
                    ';
                        ...
                        if ($interactividad['id_tipo'] == 1) {
                            ...
                            if ($pre['id_modo'] != 5) {
                                ...
                                if($interactividad["id"] == 665){

                                    echo '
                                        <div class="taC">
                                            <a href="'.$dominion.'interactividad/665/" class="dIB bVerde colorfff ff3 p1020 bHover mt20">Mejorar mi respuesta</a>
                                        </div>
                                    ';
