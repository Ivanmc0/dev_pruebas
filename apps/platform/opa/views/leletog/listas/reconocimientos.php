        ...
        <tbody>
            <?php foreach($listados AS $listado){ ?>
                <tr id="tr-<?= $listado["id"]; ?>">
                    ...
                    <td class="vM"><?= ($listado["forma"]); ?></td>
                    <td class="vM tB" style="color:<?= ($listado["color"]); ?>;"><?= ($listado["color"]); ?></td>
                    <td class="vM taC" style="padding:3px; color:<?= ($listado["color"]); ?>;"><i class="<?= ($listado["icono"]); ?> t30"></i></td>
                    <td class="vM">
                        <?= ($listado["nombre"]); ?>
                    </td>
