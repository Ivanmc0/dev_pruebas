                        ...
                        <div class="row mb20">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control form-group-margin" id="id_empresa" name="id_empresa">
                                    ...
                                    <?php
                                    $getEmpresas = $_ZOOM->get_data("olc_empresas", " AND inactivo = 0 AND eliminado = 0 ORDER BY id ASC ", 1);
                                    if ($getEmpresas) {
                        ...
                        <div class="row mb20">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control form-group-margin" id="id_categoria" name="id_categoria">
                                    <option value="0">Ninguno</option>
                                    <?php
                                    $getCategorias = $_ZOOM->get_data("grw_lel_categorias", " AND inactivo = 0 AND eliminado = 0 ORDER BY id ASC ", 1);
                                    if ($getCategorias) {
                        ...
                        <div class="row mb20">
                            <div class="col-md-6">
                                ...
                                <select class="form-control form-group-margin" id="tipo" name="tipo">
                                    <option value="1" <?php if ($edit && $getThis["tipo"] == 1) echo "selected"; ?>>Para toda la empresa</option>
                                    <option value="2" <?php if ($edit && $getThis["tipo"] == 2) echo "selected"; ?>>Para algunos empleados</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="control-label">Asignados</label>
                                <input class="form-control form-group-margin" type="text" id="asignados" name="asignados" value="<?php if ($edit) echo ($getThis["asignados"]); ?>" />
                            </div>
                        </div>
                    </div>
