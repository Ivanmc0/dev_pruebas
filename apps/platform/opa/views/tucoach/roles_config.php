                ...
                <div class="card-body">
                    ...
                    <div class="row mb20">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control form-group-margin" id="id_gruporol" name="id_gruporol">
                                ...
                                ?>
                                            <option value="<?= ($getGrupo["id"]); ?>" <?php if(($edit && $getThis["id_gruporol"] == $getGrupo["id"]) || ($edit == false && $id == $getGrupo["id"])) echo "selected"; ?>><?= ($getGrupo["nombre"]); ?></option>
                                <?php
                                        }
                                    }
                                ?>
                    ...
                    <div class="row mb20">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control form-group-margin" type="color" id="color" name="color" value="<?php if($edit) echo ($getThis["color"]); ?>" />
                        </div>
                        <div class="col-md-4">
                            <label class="control-label">¿Autoevaluado?</label>
                            <select class="form-control form-group-margin" id="auto" name="auto">
                                <option value="0" <?php if($edit && $getThis["auto"] == 0) echo "selected"; ?>>No</option>
                                <option value="1" <?php if($edit && $getThis["auto"] == 1) echo "selected"; ?>>Si</option>
                            </select>
                        </div>
                    </div>
