        ...
        <div class="card-content collapse show">
            <div class="card-header">
                ...
                <h4 class="card-title">
                    ...
                    <strong>
                        <?php
                            $grupo = $_TUCOACH->get_data("grw_tuc_segmentaciones_grupo", " AND id = ".$id." AND eliminado = 0 ORDER BY id DESC ", 0);
            ...
            <?php
                if($id != 0) $complemento = " AND id_gruposegmento = $id "; else $complemento = "";
