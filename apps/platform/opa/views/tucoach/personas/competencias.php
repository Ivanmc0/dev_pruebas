        ...
        <div class="card-content collapse show">
            <div class="card-header">
                ...
                <h4 class="card-title">
                    ...
                    <strong>
                        <?php
                            $grupo = $_TUCOACH->get_data("grw_tuc_p2p_categorias", " AND id = ".$id." AND eliminado = 0 ORDER BY id DESC ", 0);
            ...
            <?php
                if($id != 0) $complemento = " AND id_categoria = $id "; else $complemento = "";
                $listados = $_TUCOACH->get_data($access_model["tabla"], $complemento." AND eliminado = 0 ORDER BY id DESC ", 1);
                if($listados) include "listas/competencias.php";
