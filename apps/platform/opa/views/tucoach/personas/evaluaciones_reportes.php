    ...
    <div class="card">
        <div class="card-content collapse show">
            ...
            <?php
                ...
                $evaluados = $_TUCOACH->get_data($access_model["tabla"], $complemento." AND eliminado = 0 GROUP BY id_evaluado ORDER BY id DESC ", 1);
                if($evaluados) include "listas/evaluaciones_reportes.php";
