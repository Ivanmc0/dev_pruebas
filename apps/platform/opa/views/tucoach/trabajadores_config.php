                ...
                <div class="card-body">
                    ...
                    <div class="row mb20">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control form-group-margin" id="id_empresa" name="id_empresa" <?php if($edit) echo "disabled"; ?>>
                                ...
                                <?php
                                    $getGrupos = $_TUCOACH->get_data("olc_empresas", " AND inactivo = 0 AND eliminado = 0 ORDER BY id ASC ", 1);
                                    if($getGrupos){
                    ...
                    <div class="row mb20">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control form-group-margin" type="text" id="mail" name="mail" value="<?php if($edit) echo ($getThis["mail"]); ?>" />
                        </div>
                    </div>
                    <div class="row mb20">
                        <div class="col-md-4">
