        ...
        <tbody>
            <?php foreach($listados AS $listado){ ?>
                <tr id="tr-<?= $listado["id"]; ?>">
                    ...
                    <td class="vM"><?= ($listado["proyecto"]); ?></td>
                    <td class="vM" style="padding:10px !important;">
                        <div class="taC">
                            <div class="btn-group" role="group">
                                <a href="../contenidos/<?= $funcion; ?>_<?= $listado["id"]; ?>.zoom" class="btn btn-outline-primary btn-sm" title="Ver contenido">
                                    <i class="la la-eye t16"></i>
                                </a>
                            </div>
                        </div>
                    </td>
