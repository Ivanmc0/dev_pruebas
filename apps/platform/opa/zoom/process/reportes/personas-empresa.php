<?php require_once ('../../../appInit.php');
    ...
    if($thisEvaluacion){
        ...
        $ross       = $_TUCOACH->get_dataO( $cond." AND EMP.id = {$thisEvaluacion["id_empresa"]} AND ASIG.id_evaluacion = {$thisEvaluacion["id"]} ORDER BY CAT.id DESC ", $cond2." AND EMP.id = {$thisEvaluacion["id_empresa"]} AND ASIG.id_evaluacion = {$thisEvaluacion["id"]} ");
