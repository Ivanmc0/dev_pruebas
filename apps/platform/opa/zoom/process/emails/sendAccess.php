<?php require_once ('../../../appInit.php');
	...
	$zoomail_asunto 	= ($empresa["nombre"])." te ha asignado unas evaluaciones";
	$zoomail_contenido	= '

								Hola <strong>'.($trabajador["nombre"]).'</strong><br><br>

								Has sido asignado por <strong>'.($empresa["nombre"]).'</strong> para realizar algunas evaluaciones.
								<br><br>
								Para ingresar y resolverlas, siga los siguientes pasos:
								<br><br>
