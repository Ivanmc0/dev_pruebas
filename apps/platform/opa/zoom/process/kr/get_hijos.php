<?php require_once ('../../../appInit.php');
	...
	if($_POST["id"] != "" && $_POST["nivel"] != "" && $_POST["proyecto"] != "" && $_POST["week"] != "" && $_POST["today"] != ""){
		...
		$week  = $_TUCOACH->get_data("olc_semanass", " AND id = ".$_POST["week"]." AND inactivo = 0 AND eliminado = 0 ORDER BY id ASC ", 0);
			...
			foreach($datos AS $dato){
				...
				echo '
									<div class="tabIn pLR10" style="border-left:1px solid #eee; width:'.$va.';">
										...
										<div class="color666 t12">'.ucwords(strtolower(($responsable["cargo"]))).'</div>
									</div>
				';
				echo '
								</div>
