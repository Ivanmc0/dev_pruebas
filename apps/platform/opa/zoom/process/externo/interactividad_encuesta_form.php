<?php require_once('../../../appInit.php');
    ...
    if ($interactividad) {
        ...
        $respuestas = $_ZOOM->get_data("grw_sol_act_encuestas", "AND id_dinamica = " . $interactividad["id"] . " AND id_trabajador = " . $_SESSION["lele_id"] . " AND id_empresa = " . $_SESSION["lele_empresa_id"] . " AND eliminado = 0 ORDER BY id DESC ", 1);
        if ($respuestas) {
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="border:0">
        <div class="modal-content" style="border:0">
            ...
            <form action="externo/accion-encuestar" id="encuesta_<?= $interactividad["id"]; ?>" name="encuesta_<?= $interactividad["id"]; ?>" method="post" class="form-horizontal zoom_form">
                ...
                <input type="hidden" name="id_empresa" id="id_empresa" value="<?= $_SESSION['lele_empresa_id'] ?>" class="bS1" />
                <input type="hidden" name="id_trabajador" id="id_trabajador" value="<?= $_SESSION['lele_id'] ?>" class="bS1" />
                ...
                <div class="card mb30">
                    ...
                    <div class="taC mb15 eDinamicBottom dN">
